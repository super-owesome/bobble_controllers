...
gyro_filtering_data_home = os.path.abspath(os.path.join('data', 'gyro_filtering'))
balance_filtering_data_home = os.path.abspath(os.path.join('data', 'balance_filtering'))

# Load configs and data
df = parse_all_runs_in_dir(gyro_filtering_data_home)
df.update(parse_all_runs_in_dir(balance_filtering_data_home))
